...
async function renderTotalStadiums() {
  ...
  const res = await fetch(`${API}/api/cities/stats/total-stadiums`);
...
async function renderTotalCountries() {
  ...
  const res = await fetch(`${API}/api/cities/stats/total-countries`);
  const data = await res.json();
...
async function renderTotalCities() {
  ...
  const res = await fetch(`${API}/api/cities/stats/total-cities`);
  const data = await res.json();
...
function renderDeleteStadium() {
  ...
  document.getElementById("deleteStadiumBtn").addEventListener("click", async () => {
    ...
    await fetch(`${API}/api/cities/name/${encodeURIComponent(name)}/delete`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
function renderUpdateStadium() {
  ...
  document.getElementById("updateStadiumBtn").addEventListener("click", async () => {
    ...
    await fetch(`${API}/api/cities/name/${encodeURIComponent(name)}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
